import sunCareInvoiceDB from "../models/suncareInvoice.model.js"
...
export const generateZIP = asyncHandler(async (req, res) => {
    try {
        ...
        res.setHeader('Content-disposition', 'attachment; filename=InvoiceSuncareZip.zip');
        res.download(downlaodpath, "InvoiceSuncareZip.zip")
    } catch (error) {
...
export const storeData = asyncHandler(async (req, res) => {
    try {
        ...
        // store Data
        await sunCareInvoiceDB.deleteMany({});
        let data1 = await sunCareInvoiceDB.insertMany(csvData);
...
export const generatePdf = asyncHandler(async (req, res) => {
    ...
    try {
        ...
        const db = await sunCareInvoiceDB.find();
