import mindMatrixInvoiceDB from "../models/mindMatrixInvoice.model.js"
...
export const generateZIP = asyncHandler(async (req, res) => {
    try {
        ...
        res.setHeader('Content-disposition', 'attachment; filename=InvoiceMindZip.zip');
        res.download(downlaodpath, "InvoiceMindZip.zip")
    } catch (error) {
...
export const storeData = asyncHandler(async (req, res) => {
    try {
        ...
        // store Data
        await mindMatrixInvoiceDB.deleteMany({});
        let data1 = await mindMatrixInvoiceDB.insertMany(csvData);
...
export const generatePdf = asyncHandler(async (req, res) => {
    ...
    try {
        ...
        const db = await mindMatrixInvoiceDB.find();
