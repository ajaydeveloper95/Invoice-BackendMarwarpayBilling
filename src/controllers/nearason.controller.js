import nearsonInvoiceDB from "../models/nearasonInvoice.model.js"
...
export const generateZIP = asyncHandler(async (req, res) => {
    try {
        ...
        res.setHeader('Content-disposition', 'attachment; filename=InvoiceNearsonZip.zip');
        res.download(downlaodpath, "InvoiceNearsonZip.zip")
    } catch (error) {
...
export const test = asyncHandler(async (req, res) => {
    try {
        ...
        let content = await compileTemplete("index4", data)
...
export const storeData = asyncHandler(async (req, res) => {
    try {
        ...
        // store Data
        await nearsonInvoiceDB.deleteMany({});
        let data1 = await nearsonInvoiceDB.insertMany(csvData);
...
export const generatePdf = asyncHandler(async (req, res) => {
    ...
    try {
        ...
        const db = await nearsonInvoiceDB.find();
